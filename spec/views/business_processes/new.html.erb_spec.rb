...
describe "business_processes/new" do
  before(:each) do
    assign(:business_process, stub_model(BusinessProcess,
      :name => "MyString",
      :company_id => 1,
      :parent_id => 1,
      :ancestry => "MyString",
  ...
  it "renders new business_process form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => business_processes_path, :method => "post" do
